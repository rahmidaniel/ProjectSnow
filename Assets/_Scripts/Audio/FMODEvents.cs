...
namespace _Scripts.Utility
{
    public class FMODEvents : MonoBehaviour
    {
        ...
        public EventReference LogPickup { get; private set; }

        [field: SerializeField] public EventReference Damage { get; private set; }

        [field: Header("General SFX")]
        [field: SerializeField]
        public EventReference Door { get; private set; }

        [field: Header("Player SFX")]
        [field: SerializeField]
        public EventReference Running { get; private set; }
        ...
        [field: Header("Music")]
        [field: SerializeField]
        public EventReference Menu { get; private set; }
